...
def model_modifications(gly2, model_id, gly1,o2): #Quitamos gly=None
    ...
    model1=c.model('/home/iodmc/Documents/FLYCOP/Scripts/plasticDegradationEstrategy3-dPCA_10.cmd')
    ...
    model2=c.model('/home/iodmc/Documents/FLYCOP/Scripts/defaultModel-3-consumoSeparado_10.cmd')
...
def Flycop(gly2,biomass1,biomass2,gly1,o2,fitFunc='Yield', dirPlot='', repeat=10, params_package=None, params_global=None):
    ...
    if not(os.path.exists('/home/iodmc/Documents/FLYCOP/Scripts/noPCADeg_tmp.cmd')):
